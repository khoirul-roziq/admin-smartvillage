            ...
            <div class="row">
                <div class="col s12 m12 l9">
                    <div class="card-panel">
                        <h4 class="header2">Tambah Transaksi</h4>
                        <div class="row">
                            <form class="col s12" method="post" action="<?= base_url('transaksi/store') ?>">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="">
                                        <select id="" select class="js-example-basic-single" name="state">
