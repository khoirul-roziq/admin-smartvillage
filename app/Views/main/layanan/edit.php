            ...
            <div class="row">
                <div class="col s12 m12 l9">
                    <div class="card-panel">
                        <h4 class="header2">Edit Data Layanan</h4>
                        <div class="row">
                            <form class="col s12" method="post" action="<?= base_url("layanan/update/" . $layanan['kode_layanan']); ?>">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="kodeLayanan" name="kodeLayanan" type="text" value="<?= $layanan['kode_layanan'] ?>">
                                        <label for="kodeLayanan">Kode Layanan</label>
                                        <small style="color: red;"><?= $validation->getError('kodeLayanan'); ?></small>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="namaLayanan" name="namaLayanan" type="text" value="<?= $layanan['nama_layanan'] ?>">
                                        <label for="namaLayanan">Nama Layanan</label>
                                        <small style="color: red;"><?= $validation->getError('namaLayanan'); ?></small>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="hargaLayanan" name="hargaLayanan" type="text" value="<?= $layanan['harga_layanan'] ?>">
