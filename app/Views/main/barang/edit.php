            ...
            <div class="row">
                <div class="col s12 m12 l9">
                    <div class="card-panel">
                        <h4 class="header2">Edit Data Barang</h4>
                        <div class="row">
                            <form class="col s12" method="post" action="<?= base_url("barang/update/" . $barang['kode_barang']); ?>">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input id="kodeBarang" name="kodeBarang" type="text" value="<?= $barang['kode_barang'] ?>">
                                        <label for="kodeBarang">Kode Barang</label>
                                        <small style="color: red;"><?= $validation->getError('kodeBarang'); ?></small>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="namaBarang" name="namaBarang" type="text" value="<?= $barang['nama_barang'] ?>">
                                        <label for="namaBarang">Nama Barang</label>
                                        <small style="color: red;"><?= $validation->getError('namaBarang'); ?></small>
                                    </div>
                                    <div class="input-field col s12">
                                        <input id="hargaBarang" name="hargaBarang" type="text" value="<?= $barang['harga_barang'] ?>">
