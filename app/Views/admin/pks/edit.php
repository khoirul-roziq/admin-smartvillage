            ...
            <form action="<?= base_url("pks/update/" . $pks['id_pks']); ?>" id="add_layanan" method="POST">
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                        ...
                        <input id="namaDesa" name="namaDesa" type="text" value="<?= $pks['nama_desa'] ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Kode Layanan" />
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <input id="namaKades" name="namaKades" type="text" value="<?= $pks['nama_kades'] ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Nama Layanan" />
                        <small style="color: red;"><?= $validation->getError('namaKades'); ?></small>
                    </label>

                    <label class="block mt-4 text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Tanggal</span>
                        <input id="tanggalPks" name="tanggalPks" type="date" value="<?= $pks['tanggal'] ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Harga Layanan" />
