<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="flex flex-col flex-wrap mb-8 space-y-4 md:flex-row md:items-end md:space-x-4">
            ...
            <button onclick="window.location.href=`<?= base_url('/barang/importFile') ?>`" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg active:bg-teal-600 hover:bg-teal-900 focus:outline-none focus:shadow-outline-purple">
            ...
            <button onclick="window.location.href=`<?= base_url('/barang/export') ?>`" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg active:bg-teal-600 hover:bg-teal-900 focus:outline-none focus:shadow-outline-purple">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-2 -ml-1" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        if(confirm('Apakah anda yakin ingin menghapus data barang ini?')){
                                            window.location.href=`<?= base_url('barang/' . $index['kode_barang'] . '/delete') ?>`
                                        }
