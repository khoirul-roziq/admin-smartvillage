                ...
                <tr class="text-gray-700 dark:text-black-400">
                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                      ...
                      window.location.href=`<?= base_url('/transaksi/delete/barang') . '/' . $data['id_barang'] . '/' . $data['id_pelanggan'] . '/' . $data['tanggal'] ?>`
                ...
                <tr class="text-gray-700 dark:text-black-400">
                  ...
                  <td class="px-4 py-3">
                    <div class="flex items-center space-x-4 text-sm">
                      ...
                      <button onclick="
                      if(confirm('Apakah anda yakin ingin menghapus data ini?')){
                      window.location.href=`<?= base_url('/transaksi/delete/layanan') . '/' . $data['id_layanan'] . '/' . $data['id_pelanggan'] . '/' . $data['tanggal'] ?>`
                      }" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Delete">
                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                          <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        </svg>
