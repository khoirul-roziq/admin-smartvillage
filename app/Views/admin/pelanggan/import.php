<body>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <?php endif; ?>
            <form action="<?= base_url('pelanggan/import') ?>" id="add_pelanggan" enctype="multipart/form-data" method="POST">
                <?= csrf_field() ?>
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Import Data dari File Excel</span>
                        <input id="namaPelanggan" name="file" type="file" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Import File" />
                    </label>
