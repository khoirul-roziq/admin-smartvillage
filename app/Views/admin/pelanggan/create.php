<body>
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <?php endif; ?>
            <form action="<?= base_url('pelanggan/store') ?>" id="add_pelanggan" method="POST">
                <?= csrf_field() ?>
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <label class="block text-sm">
                        <span class="text-gray-700 dark:text-gray-400">Nama Pelanggan</span>
                        <input id="namaPelanggan" name="namaPelanggan" type="text" value="<?= old('namaPelanggan'); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Nama Pelanggan" />
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <input id="telepon" name="telepon" type="text" value="<?= old('telepon'); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Nomor Telepon" />
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <input id="alamat" name="alamat" type="text" value="<?= old('alamat'); ?>" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Masukkan Alamat" />
