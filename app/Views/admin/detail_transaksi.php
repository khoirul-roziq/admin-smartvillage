<main class="h-full pb-16 overflow-y-auto">
  <div class="container grid px-6 mx-auto">
    ...
    <div class="min-w-full mb-8 p-4 text-white bg-purple-600 rounded-lg shadow-xs">
      <?php
      ...
      <div class="flex items-center  text-sm">
        ...
        <div style="margin-left: 30px;">
          ...
          <p class="text-base text-white-600 dark:text-gray-400 mb-4"><?= $nama ?></p>
          <p class="text-lg font-semibold te">Alamat </p>
          <p class="text-base text-white-600 dark:text-gray-400 mb-4"><?= $alamat ?></p>
          <p class="text-lg font-semibold te">Kontak </p>
          <p class="text-base text-white-600 dark:text-gray-400"><?= $telp ?></p>
        </div>
      </div>
    </div>
